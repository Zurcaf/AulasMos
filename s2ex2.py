...
model.addConstr(2*x1 + x2<= 18, "1 Constraint")
model.addConstr(x1 + 2*x2 <= 15, "2 Constraint")
model.addConstr(x1 <= 8, "3 Constraint")
model.addConstr(x2 <= 6, "4 Constraint")
model.addConstr(x1 >= 0, "5 Constraint")
model.addConstr(x2 >= 0, "6 Constraint")
